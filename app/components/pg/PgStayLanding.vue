...
export type PgStayNavLink = { label: string; to: string }

export type PgStayPillar = {
  icon: Component
  title: string
  body: string
}
...
const props = defineProps<{
  ...
  title: string
  subtitle: string
  /** e.g. "Search co-living in" — city label is appended in the UI */
  searchIntro: string
  navLinks: PgStayNavLink[]
  pillarsSectionEyebrow: string
  pillarsHeading: string
  pillarsLead: string
  pillars: PgStayPillar[]
  previewKicker: string
  /** Line before city in preview heading, e.g. "Fresh stays in" */
...
const heroBgStyle = computed(() => ({
  background: intentHeroBackgrounds.pg,
}))

const previewFilters = computed(() =>
  parseListingPageQuery(
    { intent: 'pg', city: city.value } as Record<string, unknown>,
    { defaultIntent: 'pg' },
  ),
)
  ...
  <div class="w-full overflow-x-hidden">
    ...
    >
      ...
      >
        ...
        />
        <HeroLineArtBackdrop intent="pg" class="absolute inset-0 z-[1]" />
      </div>
        ...
        <div class="mx-auto w-full max-w-3xl">
          ...
          >
            ...
            <div class="p-3.5 sm:p-5 md:p-6">
              ...
              <div class="mt-1">
                <label class="sr-only" :for="localityInputId">Locality or landmark</label>
                <div
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      placeholder="Metro, college, IT park…"
                      autocomplete="off"
